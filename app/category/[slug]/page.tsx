      ...
      <div className="relative rounded-3xl overflow-hidden mb-8 h-48 sm:h-64">
        ...
        <div className="absolute inset-0 flex items-center px-8">
          <div className="text-white">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold" style={{ fontFamily: 'Playfair Display, serif' }}>{cat.name}</h1>
            <p className="text-white/80 mt-1">{cat.description}</p>
            <p className="text-white/60 text-sm mt-1">{items.length} products</p>
          </div>
        </div>
      </div>
