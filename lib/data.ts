...
export const products: Product[] = [
  ...
  {
    id:'p017', name:"LIBAS Women Kurta Palazzo Set", brand:'LIBAS',
    price:1389, originalPrice:1999, discount:31, rating:4.3, reviews:659,
    image:'/products/itmfa38428e35789.jpg',
    category:'fashion', tags:['kurta','palazzo','ethnic','libas','cotton','festive','white'],
    description:'Elegant white ethnic kurta palazzo set with delicate floral embroidery detailing on the neckline. Includes matching dupatta — perfect for festive occasions and casual ethnic days.',
    features:['Soft, breathable fabric','Floral embroidered neckline','Includes kurta, palazzo & dupatta','Bell sleeves for a flattering fit','Comfortable everyday ethnic wear'],
    affiliateUrl:'https://fktr.in/cUrN0wt', affiliateSource:'flipkart', badge:'trending', inStock:true,
  },
  {
    id:'p018', name:"G Bluxe Women Kurta Palazzo Dupatta Set", brand:'G Bluxe',
    price:581, originalPrice:1999, discount:71, rating:4.0, reviews:33,
    image:'/products/itm8dcbf28cf7f6d.jpg',
    category:'fashion', tags:['kurta','palazzo','dupatta','ethnic','floral','festive'],
    description:'Beautiful sage-green floral printed kurta palazzo set with a contrasting coral border and matching dupatta. A vibrant, festive ethnic ensemble.',
    features:['Floral block-print pattern','Matching dupatta included','Contrasting coral border detail','Comfortable relaxed fit','Great for festive & casual wear'],
    affiliateUrl:'https://fktr.in/SdhGoJd', affiliateSource:'flipkart', badge:'bestseller', inStock:true,
  },
];
